...
<div class="container">
    ...
    <div class="form-elements">
        ...
        <div>
            ...
            <textarea id="message" name="message" required placeholder="Describe your problem here... For example, you got lottery but didn't know how to spend the money and need my help for that..." oninput="this.style.height = ''; this.style.height = this.scrollHeight + 'px'"></textarea><br>
        </div>
