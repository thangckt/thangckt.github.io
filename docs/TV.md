...
<div class="content-column" >
  <p style="font-size:16pt; margin-top:0; margin-bottom:20">News</p>
  ...
  <button class="pushable" onclick="loadPlayer(['https://ntd02.akamaized.net/NTD-West/index.m3u8','https://ntd02.akamaized.net/NTDA/index.m3u8'])"> <span class="front">NTD</span> </button>
