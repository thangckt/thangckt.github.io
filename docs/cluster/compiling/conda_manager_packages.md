...
conda install --update-specs -y -c conda-forge python=3.9.0 gcc=11 gxx=11 gfortran=11 \
    libgcc-ng=11 libgfortran-ng=11 libstdcxx-ng=11 zlib=1.2.11 libibverbs-cos7-aarch64
```
#### UCX
``` sh
