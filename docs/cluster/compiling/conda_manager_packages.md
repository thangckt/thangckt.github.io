...
conda install --update-specs -y -c conda-forge python=3.9.0 gcc=12 libgcc-ng=12 libgfortran-ng=12 libstdcxx-ng=12 zlib=1.2.11 \
    libibverbs-cos7-x86_64 numactl-libs-cos7-x86_64 rdma-core
```
#### UCX
``` sh
