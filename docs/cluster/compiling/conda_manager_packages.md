...
conda install -y -c conda-forge python=3.11 gcc=11 gxx=11 gfortran=11 sysroot_linux-64=2.12 \
    ucx=1.9 openmpi=4.1.1 ase libxc openblas scalapack fftw numpy matplotlib pillow # gpaw=23 lammps
