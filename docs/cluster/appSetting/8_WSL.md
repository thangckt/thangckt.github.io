...
May also need to update WSL2 Linux kernel, by download at [this link](https://wslstorestorage.blob.core.windows.net/wslblob/wsl_update_x64.msi), or run in `cmd`
```
wls --update
```
