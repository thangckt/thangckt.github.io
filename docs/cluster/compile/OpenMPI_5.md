...
- `prrte` docs error, to disable build docs, delete `docs` in `SUBDIRS` of `/home1/p001cao/0SourceCode/ompi-5.0.x/3rd-party/prrte/Makefile.in` [see this](https://unix.stackexchange.com/questions/430627/how-do-i-avoid-make-to-generate-and-install-man-pages)
