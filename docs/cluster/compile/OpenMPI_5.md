...
- to disable build docs, delete `docs` in `SUBDIRS` of `Makefile.in` [see this](https://unix.stackexchange.com/questions/430627/how-do-i-avoid-make-to-generate-and-install-man-pages)
